...
export const AF_ORGS = [
  { id: 'a_fumigatus', name: 'A. fumigatus', category: 'MOLDS', sources: ['all', 'hap'] },
  { id: 'a_niger', name: 'A. niger', category: 'MOLDS', sources: ['all'] },
  { id: 'a_terreus', name: 'A. terreus', category: 'MOLDS', sources: ['all'] },
  { id: 'a_flavus', name: 'A. flavus', category: 'MOLDS', sources: ['all'] },
  { id: 'c_albicans', name: 'C. albicans', category: 'YEASTS', sources: ['all', 'uti_comp', 'uti_simple'] },
  { id: 'c_auris', name: 'C. auris', category: 'YEASTS', sources: ['all', 'uti_comp'], crit: 1 },
  { id: 'c_dubliniensis', name: 'C. dubliniensis', category: 'YEASTS', sources: ['all'] },
  { id: 'c_glabrata', name: 'C. glabrata', category: 'YEASTS', sources: ['all', 'uti_comp'], crit: 1 },
  { id: 'c_guilliermondii', name: 'C. guilliermondii', category: 'YEASTS', sources: ['all'] },
  { id: 'c_krusei', name: 'C. krusei', category: 'YEASTS', sources: ['all'], crit: 1 },
  { id: 'c_lusitaniae', name: 'C. lusitaniae', category: 'YEASTS', sources: ['all'] },
  { id: 'c_parapsilosis', name: 'C. parapsilosis', category: 'YEASTS', sources: ['all'] },
  { id: 'c_tropicalis', name: 'C. tropicalis', category: 'YEASTS', sources: ['all'] },
  ...
  { id: 'fusarium', name: 'Fusarium sp.', category: 'MOLDS', sources: ['all', 'ssti'] },
  { id: 'mucor', name: 'Mucormycosis', category: 'MURAL', sources: ['all', 'ssti'] },
  ...
  { id: 'blastomyces', name: 'Blastomyces', category: 'DIMORPHIC', sources: ['all'] },
  { id: 'coccidioides', name: 'Coccidioides', category: 'DIMORPHIC', sources: ['all'] },
  { id: 'histoplasma', name: 'Histoplasma', category: 'DIMORPHIC', sources: ['all'] },
